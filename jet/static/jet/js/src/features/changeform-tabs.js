    ...
    updateErrorState: function() {
        ...
        $tabItems.each(function() {
            ...
            if (selector) {
                ...
                var error_exists = $contentWrapper.find('.form-row.errors').length + $contentWrapper.find('.form-box.errors').length 
                    error_exists += $contentWrapper.find('.errorlist').length
                if (error_exists) {
